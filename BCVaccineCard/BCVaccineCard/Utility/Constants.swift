...
struct Constants {
    struct Strings {
        ...
        struct Settings {
            ...
            static let openingText = "My Health BC app is the official mobile application from the Government of British Columbia which allow you to store and organize the proof of vaccination of you and your family members."
            static let privacyStatement = "Privacy Statement"
