...
enum TabBarVCs {
    ...
    var properties: Properties? {
        switch self {
        case .healthPass:
            return Properties(title: .healthPass, tabBarImage: #imageLiteral(resourceName: "my-cards-tab"), baseViewController: CardsBaseViewController.constructCardsBaseViewController())
        case .records:
            return nil
        case .checker:
            return nil
